          ...
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit">{{ __('Iniciar sesión') }}</button>
                                
                <div class="text-center">
                  @if (Route::has('password.request'))
                    <a class="small" href="{{ route('password.request') }}">{{ __('Has olvidado tu Password?') }}</a></div>
                  @endif
              </form>
            </div>
          </div>
